prog: prog.c fonctions.c lib_2d.o lib_mat.o lib_surface.o lib_3d_etu.o lib_objet3d_etu.o lib_scene3d_etu.o
	gcc -g prog.c fonctions.c lib_2d.o lib_mat.o lib_surface.o lib_3d_etu.o lib_objet3d_etu.o lib_scene3d_etu.o PA_3d.o PA_objet3d.o PA_scene3d.o -lm -lSDL -o prog
